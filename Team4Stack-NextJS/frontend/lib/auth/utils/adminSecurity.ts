...
const getAllowedAdminEmails = (): string[] => {
  const envAdmins = process.env.NEXT_PUBLIC_ALLOWED_ADMIN_EMAILS as string | undefined;
...
export const getAdminSecurityStatus = (): {
  ...
  return {
    ...
    allowedEmails: process.env.NODE_ENV === 'development' ? allowedEmails : [] // Only show in development
  };
};
