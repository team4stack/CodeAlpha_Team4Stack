...
const QuizManagementModal: React.FC<Props> = ({ isOpen, onClose, videoId, videoTitle }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col ${isDarkMode ? 'border border-gray-700' : 'border border-gray-200'}`}>
        {/* Header */}
