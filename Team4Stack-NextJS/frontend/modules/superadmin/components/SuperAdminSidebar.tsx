...
const SuperAdminSidebar: React.FC = () => {
  ...
  const links = [
    { to: '/supadmin', label: 'Super Admin Dashboard', icon: FiLayout, isSuper: true },
    { to: '/supadmin/roles', label: 'Role Management', icon: FiLock, isSuper: true },
    { to: '/supadmin/users', label: 'All Users', icon: FiUsers, isSuper: true },
    { to: '/supadmin/admins', label: 'Admin Management', icon: FiShield, isSuper: true },
    { to: '/supadmin/system', label: 'System Settings', icon: FiSettings, isSuper: true },
    { to: '/supadmin/audit', label: 'Audit Logs', icon: FiFileText, isSuper: true },
    { to: '/adminlandingt4s', label: 'Landing Page Admin', icon: FiLayout, isSuper: false },
    { to: '/admincourset4s', label: 'Courses Admin', icon: FiBook, isSuper: false },
    { to: '/adminteamt4s', label: 'Team Admin', icon: FiUsers, isSuper: false },
    { to: '/adminstackt4s', label: 'StackStore Admin', icon: FiGrid, isSuper: false },
  ]
