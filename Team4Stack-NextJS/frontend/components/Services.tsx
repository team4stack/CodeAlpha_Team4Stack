        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {dbServices.length > 0 ? dbServices.map((s) => {
            ...
            const getDefaultEmoji = (title: string) => {
              ...
              if (titleLower.includes('website') || titleLower.includes('mern')) return '🌐';
              if (titleLower.includes('physical')) return '🏫';
              if (titleLower.includes('online')) return '💻';
              if (titleLower.includes('portfolio')) return '🧩';
              if (titleLower.includes('shop') || titleLower.includes('business')) return '🛒';
              if (titleLower.includes('ui') || titleLower.includes('ux') || titleLower.includes('design')) return '🎨';
              if (titleLower.includes('qa') || titleLower.includes('test')) return '🧪';
              if (titleLower.includes('devops') || titleLower.includes('deployment')) return '🚀';
              return '✅';
            };
