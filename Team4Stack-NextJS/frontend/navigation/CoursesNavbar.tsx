...
const CoursesNavbar: React.FC = () => {
  ...
  const isCoursesActive =
    pathname === '/courses' ||
    (pathname?.startsWith('/courses/') && !pathname?.startsWith('/courses/apply'))
  const isApplyActive = pathname?.startsWith('/courses/apply')
        ...
        <div className="container-custom px-4 sm:px-6 relative">
          <div className="home-nav__bar">
            ...
            <div className="home-nav__dock hidden md:flex">
              <button
                type="button"
                className={`home-nav__link btn-plain${isCoursesActive ? ' home-nav__link--active' : ''}`}
              ...
              <button
                type="button"
                className={`home-nav__link btn-plain${isApplyActive ? ' home-nav__link--active' : ''}`}
