-- Developer public profiles + client-developer messaging (backend service-role only)
...
create index if not exists developer_profiles_user_email_idx on public.developer_profiles (lower(user_email));
create index if not exists profile_conversations_dev_idx on public.profile_conversations (developer_profile_id, updated_at desc);
create index if not exists profile_conversations_client_email_idx on public.profile_conversations (lower(client_email));
create index if not exists profile_messages_conversation_idx on public.profile_messages (conversation_id, created_at asc);
