...
const About: React.FC = () => {
  ...
  const bannerImages = [
    ...
    'https://images.unsplash.com/photo-1518770660439-ec3579fee39f?q=80&w=1600&auto=format&fit=crop',
  ...
  return (
    <section id="about" className={`section-padding ${isDarkMode ? 'bg-gradient-to-b from-black to-gray-900' : 'bg-white'}`}>
      ...
      <div className="container-custom">
        ...
        {mentor && (
          <div className="flex items-center justify-center py-8 px-0 mb-8 w-full">
            <div className="w-full">
              {/* Desktop: Horizontal layout - hidden on mobile */}
              <div className={`t4s-card large mentor-neon horizontal hidden md:block ${isDarkMode ? 'bg-white/10 border-white/25' : 'bg-gray-50 border-gray-200'}`}>
                {/* Column 1: Background Image */}
                <div 
                  className="banner" 
                  style={{ 
                    backgroundImage: `url(${mentor.bannerImage || 'https://images.unsplash.com/photo-1517433456452-f9633a875f6f?q=80&w=1600&auto=format&fit=crop'})`
                  }}
                >
                ...
                <div className="content">
                  <h1 className={`text-3xl font-display font-bold mb-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>
                    {mentor.name}
                  </h1>
                  <p className={`text-xl font-medium mb-6 text-center ${isDarkMode ? 'text-purple-blue-300' : 'text-purple-600'}`}>
                    {mentor.role}
                  </p>
                ...
                {/* Column 3: Buttons - Desktop */}
                <div className="actions hidden md:flex flex-col justify-center items-center w-full">
                  <div className="w-full mb-1 flex justify-center">
                    <a 
                      className="portfolio-btn-new flex items-center justify-center font-medium transition-all rounded-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-4 py-3 relative"
                      style={{ 
                        textDecoration: 'none', 
                        borderRadius: '50px',
                        position: 'relative',
                  ...
                  <div className="w-full mb-1 flex justify-center">
                    <a 
                      className="github-btn-navbar-style flex items-center justify-center font-medium border transition-colors rounded-lg"
                      style={{ width: '160px' }}
                      href={mentor.github || '#'} 
                      target="_blank" 
                      rel="noopener noreferrer"
              ...
              {/* Mobile: Original vertical layout - hidden on desktop */}
              <div className={`t4s-card large mentor-neon block md:hidden ${isDarkMode ? 'bg-white/10 border-white/25' : 'bg-gray-50 border-gray-200'}`}>
