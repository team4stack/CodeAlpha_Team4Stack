        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard 
              ...
              trend="" 
              icon="🛠️" 
              onClick={() => navigate('/adminsami/projects')}
            />
            <StatCard 
              title="Reviews" 
              value={stats.reviews} 
              icon="⭐" 
              onClick={() => navigate('/adminsami/reviews')}
              badges={[
            ...
            <StatCard 
              ...
              icon="💼" 
              onClick={() => navigate('/adminsami/services')}
              badges={[
            ...
            <StatCard 
              ...
              trend="" 
              icon="🎓" 
              onClick={() => navigate('/adminsami/courses')}
            />
            <StatCard 
              title="Admission Form" 
              value={stats.contacts} 
              icon="📧"
              onClick={() => navigate('/adminsami/forms')}
              badges={[
            ...
            <StatCard 
              ...
              value={stats.users} 
              icon="👤"
              onClick={() => navigate('/adminsami/users')}
              badges={[
            ...
            <StatCard 
              ...
              icon="💬" 
              onClick={() => navigate('/adminsami/support')}
              badges={[
                    ...
                    <div 
                      ...
                      onClick={() => {
                        const routes: Partial<Record<Activity['type'], string>> = {
                          project: '/adminsami/projects',
                          service: '/adminsami/services',
                          review: '/adminsami/reviews',
                          course: '/adminsami/courses',
                          contact: '/adminsami/contact',
                          user: '/adminsami/users',
                          support: '/adminsami/support'
                        }
                        navigate(routes[activity.type] || '/adminsami')
                      }}
                    >
