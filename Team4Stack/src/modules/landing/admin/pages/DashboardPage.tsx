        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard 
              ...
              trend="" 
              icon="🛠️" 
              onClick={() => navigate('/adminlandingt4s/projects')}
            />
            <StatCard 
              title="Reviews" 
              value={stats.reviews} 
              icon="⭐" 
              onClick={() => navigate('/adminlandingt4s/reviews')}
              badges={[
            ...
            <StatCard 
              ...
              icon="💼" 
              onClick={() => navigate('/adminlandingt4s/services')}
              badges={[
            ...
            <StatCard 
              ...
              trend="" 
              icon="🎓" 
              onClick={() => navigate('/adminlandingt4s/courses')}
            />
            <StatCard 
              title="Admission Form" 
              value={stats.contacts} 
              icon="📧"
              onClick={() => navigate('/adminlandingt4s/forms')}
              badges={[
            ...
            <StatCard 
              ...
              value={stats.users} 
              icon="👤"
              onClick={() => navigate('/adminlandingt4s/users')}
              badges={[
            ...
            <StatCard 
              ...
              icon="💬" 
              onClick={() => navigate('/adminlandingt4s/support')}
              badges={[
                  ...
                  {recentActivity.map((activity, index) => (
                    <div 
                      ...
                      onClick={() => {
                        ...
                        navigate(routes[activity.type] || '/adminlandingt4s')
                      }}
                    >
