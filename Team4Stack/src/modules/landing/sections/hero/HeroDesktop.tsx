    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 z-[1]" aria-hidden="true">
          {/* Large rotating grid (restarts when hero comes back into view) */}
          <div
            key={gridCycle}
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[170vmax] h-[170vmax] rounded-[48px] opacity-35 motion-safe:animate-spin motion-reduce:animate-none"
            style={{
